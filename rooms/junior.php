...
<body>
	<div class="room" style="color: white; background-color: rgba(40,40,40,1);">
		<h3 style="margin-left: 5%; margin-top: 7%; color: white;"><center>Junior Room Type</center></h3>
		<img src="../Images/rooms/j.png" style="width: 90%; margin-left: 2%; margin-top: -15%;">
		<div class="rText">
			<h4 style="color: white;">Php 2,800.00</h4>
			<h5 style="color: white;">Max. of 4persons</h5>
			<p style="color: white;">The most commonly defined as a room that features a separate living-sitting area, in addition to the bedroom.</p>		
			<br><br>	
		</div>
...
<div class="red box">
    				...
    				<div class="btn">
						<a href="../insert/jpinsert.php"><input type="submit" name="submit" value="Reserve"></a>	
					</div>
					</form>
			    </div>
    			<div class="green box">
    				...
    				<div class="btn">
						<a href="../insert/jcinsert.php"><input type="submit" name="submit" value="Reserve"></a>	
					</div>
					</form>
    			</div>
				</label>
