...
<body>
	<div class="room">
		<h3 style="margin-left: 5%; margin-top: 7%;"><center>Suite Room Type</center></h3>
		<img src="../Images/rooms/s.png" style="width: 90%; margin-left: 2%; margin-top: -15%;">
		<div class="rText">
			<h4>Php 3,200.00</h4>
			<h5>Max. of 6persons</h5>
			<p>It provides access to the Club Lounge where guests enjoy exclusivity and premium service; daily Continental breakfast; all-day refreshments and cocktails; iMac stations; work tables; reading materials; a wide-screen LED HDTV with cable channels; and secretarial assistance.</p>		
			<br><br>	
		</div>
		...
		<div style="margin-left: 5%; padding: 5%;">
			<div class="payment">
			    ...
			    <div class="red box">
    				...
    				<div class="btn">
						<a href="../insert/pinsert.php"><input type="submit" name="submit" value="Reserve"></a>	
					</div>
					</form>
			    </div>
    			<div class="green box">
