		...
		<div style="margin-left: 5%; padding: 5%;">
			<div class="payment">
			    ...
			    <div class="red box">
					...
					<br><input type="checkbox" name="terms" value="terms" required><label> I have read and agreed to the </label> <a href="../terms.pdf" download>Terms and Condition<br>
    				<div class="btn">
    			...
    			<div class="green box">
					...
					<div class="personal">
	    				...
	    				<br><input type="checkbox" name="terms" value="terms" required><label> I have read and agreed to the </label> <a href="../terms.pdf" download>Terms and Condition<br></a>
